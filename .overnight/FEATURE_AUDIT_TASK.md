...
You are running a Feature Audit for project **cashu-l402**.
...
python -m boxes.ai_features --project "C:/code/te-btc/cashu-l402" --mode deep --output "C:/code/te-btc/cashu-l402/.overnight/feature_audit_raw.json"
```
...
Write this JSON to `C:/code/te-btc/cashu-l402/.overnight/feature_audit_output.json`:
